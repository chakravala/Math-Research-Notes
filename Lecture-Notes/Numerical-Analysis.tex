...
\begin{example}
	...
	\end{align*}
	Need at least 45 points. (FINISH from picture)
\end{example}
...
\begin{example}
	...
	$$ \frac{(\pi-0)^4}{384} \max_{0\leq\xi\leq\pi} |f^{(4)}(\xi)| = \frac{\pi^4}{384} \approx 0.0257\times\pi^2.$$
